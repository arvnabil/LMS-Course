                            ...
                            <nav className="-mx-3 flex flex-1 justify-end items-center gap-4">
                                ...
                                {auth.user ? (
                                    <Link
                                        ...
                                        className="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white bg-primary text-white hover:bg-primary/90"
                                    >
                                        Dashboard
                                    </Link>
                                ) : (
                                    <>
                                        ...
                                        <Link
                                            href={route('register')}
                                            className="bg-primary text-white rounded-xl px-6 py-2 transition hover:bg-primary/90 focus:outline-none focus-visible:ring-[#FF2D20] dark:focus-visible:ring-white font-bold shadow-lg shadow-primary/20"
                                        >
                                            Register
                                        </Link>
                                    </>
