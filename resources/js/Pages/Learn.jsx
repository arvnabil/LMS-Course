                                    ...
                                    <div key={section.id} className="space-y-2">
                                        ...
                                        <div className={`space-y-0.5 transition-all duration-300 ease-in-out ${isExpanded ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                                            {[
                                                ...
                                                if (isLocked) {
                                                    return (
                                                        <div key={`${item.itemType}-${item.id}`} className="w-full text-left px-3 py-3 rounded-2xl flex items-center gap-3 opacity-25 cursor-not-allowed">
                                                            <div className="w-5 h-5 rounded-md bg-gray-200 flex items-center justify-center shrink-0">
                                                            ...
                                                            <span className="text-xs font-bold text-gray-400 truncate">{item.title}</span>
                                                        </div>
                                                    );
                                                }
