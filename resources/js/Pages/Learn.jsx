                ...
                <div className="flex flex-1 overflow-hidden relative">
                    ...
                    <main className="flex-1 overflow-y-auto flex flex-col relative bg-white dark:bg-zinc-950 scroll-smooth">
                        ...
                        {currentLesson?.is_quiz ? (
                            ...
                            /* Video Player Area */
                            <div ref={videoContainerRef} className="w-full aspect-[16/10] bg-black flex items-center justify-center relative group overflow-hidden">
                        ...
                        {currentLesson?.type === 'file' && currentLesson?.file_id && (() => {
                            ...
                            return (
                                <div className="w-full flex flex-col bg-white dark:bg-zinc-900/30">
                                    ...
                                    {/* Viewer Area */}
                                    <div className="w-full aspect-[16/10] overflow-hidden relative flex items-center justify-center bg-gray-900 shadow-inner">
                                        {isPdf ? (
                                            <iframe 
