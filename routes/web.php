...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/dashboard/mentor/lessons/{lesson}/upload-video', [\Modules\Course\Http\Controllers\Mentor\CourseBuilderController.php, 'uploadLessonVideo'])->name('mentor.lessons.upload-video');
